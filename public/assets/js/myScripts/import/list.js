...
var KTImportsList = function () {
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-kt-imports-table-filter="search"]');
    ...
    var handleFilter = function () {
        ...
        const filterForm = document.querySelector('[data-kt-imports-table-filter="form"]');
        const filterButton = filterForm.querySelector('[data-kt-imports-table-filter="filter"]');
        const resetButton = filterForm.querySelector('[data-kt-imports-table-filter="reset"]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-kt-imports-table-filter="delete_row"]');
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                // Get imports name
                const importsName = parent.querySelectorAll('td')[1].innerText;

                // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                Swal.fire({
                    text: "Are you sure you want to delete " + importsName + "?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        Swal.fire({
                            text: "You have deleted " + importsName + "!.",
                            icon: "success",
                            buttonsStyling: false,
                        ...
                        Swal.fire({
                            text: importsName + " was not deleted.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
    ...
    return {
        ...
        init: function () {
            table = document.querySelector('#kt_imports_table');
